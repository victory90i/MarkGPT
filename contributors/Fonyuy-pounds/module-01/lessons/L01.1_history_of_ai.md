...
## Executive Summary: The 70-Year Journey of AI

This lesson tracks the 70-year evolution of Artificial Intelligence, from early philosophical questions to the powerful language models we use today.

*   **1950s (The Starting Question):** Alan Turing proposed the "Imitation Game" (Turing Test) to measure machine intelligence by its ability to act human, shifting focus to what intelligence *does* rather than what it *is*.
*   **1950s–1980s (Rule-Based AI):** "Symbolic AI" tried to program intelligence with strict, explicit rules (like complex grammar rules). It failed because human language has too many exceptions.
*   **1980s–2000s (Learning Like a Brain):** Scientists built Artificial Neural Networks to learn patterns from examples, using an algorithm called "Backpropagation" to self-correct mistakes. 
*   **2006–2015 (Deep Learning Explosion):** The combination of massive internet data, powerful GPUs, and "deep" networks led to sudden, massive leaps in AI capability.
*   **2013–2019 (Meaning & Context):** AI learned to represent words as mathematical coordinates (Word Embeddings) and understand context (like the difference between a river "bank" and a financial "bank") with models like BERT.
*   **2017–Present (The Transformer):** The Transformer architecture processes entire sentences simultaneously using "Attention," enabling massive scaling and creating modern giants like ChatGPT.
*   **Your Journey (MarkGPT):** MarkGPT uses the exact same Transformer technology but focuses on Biblical literature and the Banso language, proving AI can preserve culture.
